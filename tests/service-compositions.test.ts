...
test("bloqueia compostos diferentes com componente efetivo em comum", () => {
  assert.equal(
    serviceSelectionIssue(
      ["cut-and-beard", "cut-and-eyebrow"],
      [
        { composite_service_id: "cut-and-beard", component_service_id: "cut" },
        { composite_service_id: "cut-and-beard", component_service_id: "beard" },
        { composite_service_id: "cut-and-eyebrow", component_service_id: "cut" },
        { composite_service_id: "cut-and-eyebrow", component_service_id: "eyebrow" },
      ],
    ),
    "composition",
  );
...
test("bloqueia composto com componente selecionado separadamente", () => {
  assert.equal(
    serviceSelectionIssue(
      ["cut-beard-eyebrow", "beard"],
      [
        { composite_service_id: "cut-beard-eyebrow", component_service_id: "cut" },
        { composite_service_id: "cut-beard-eyebrow", component_service_id: "beard" },
        { composite_service_id: "cut-beard-eyebrow", component_service_id: "eyebrow" },
      ],
    ),
    "composition",
  );
